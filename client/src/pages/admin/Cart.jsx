          ...
          <div className="">
              ...
              <div className="grid col-span-6  md:grid-cols-8  w-full self-center gap-1 md:gap-6 lg:gap-0 pb-2">
                <div className="flex gap-4 col-span-3 md:col-span-5">
                  <img src={product.imageUrl} alt="" className="w-24 h-24 self-center" />
                  <div className="self-center">
                    <p>{product.title} </p>
                    <p></p>
                  </div>
                </div>
                <p className="self-center pl-10 md:pl-0">{product.newPrice}</p>
                <select name="listofnum" id="listofnum" className="self-center overflow-auto scroll-m-0 scroll-p-0 h-8 w-14 rounded-lg text-center bg-white border-2" size='1' value={product.quantity }>
