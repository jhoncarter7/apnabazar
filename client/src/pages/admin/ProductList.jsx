  ...
  return (
    <main className="flex justify-between gap-3 md:gap-8">
     ...
     <div  className="w-full grid  grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 overflow-hidden gap-y-4">
      ...
      <div className="w-[65vw]  md:w-[42vw] lg:w-[18vw] shadow-md p-[2vw] rounded-md" key={product._id}>
      ...
      <div className="flex justify-between">
        <div>
          ...
          <p className="text-xs text-gray-600 line-through items-center">{product.oldPrice}</p>
        </div>
        <button className="border-2 px-8 border-green-500 rounded-md bg-green-100 text-green-500 font-semibold cursor-pointer">EDIT</button>
      </div>
    </div>
